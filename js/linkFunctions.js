  ...
  $.getJSON('view_links.php', function(links) {
    ...
    $.each(links, function(index, link) {
      var linkDiv = $('<a href="'+ link.link_url +'" target="_blank"></a>')
        ...
        } else if (link.link_category === 'Swift') {
           $('#swiftContent').append(linkDiv);
        }     
...
$(document).ready(function() {
  getLinks();
    ...
    $('#projListC, #projListPy, #projListSwift').on('click', '.linkItem', function() {
