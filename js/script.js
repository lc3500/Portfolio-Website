...
$(window).ready(function main() {
    ...
    $(".swiftHeader").click(function() {
        console.log("Swift Clicked");
        if($("#swiftContent").is(":visible")) {
            console.log("Visible Swift");
             $(".swiftarrow").css("transform", "rotate(0deg)");
            $("#swiftContent").toggleClass("retract");
            $("#swiftContent").delay(500).queue(function() {
                $(this).css("display", "none");
                $(this).dequeue();
            });
        } else if ($("#swiftContent").is(":hidden")){
            console.log("Swift Hidden");
            $(".swiftarrow").css("transform", "rotate(180deg)");
             $("#swiftContent").css("display", "flex");
            $("#swiftContent").delay(1).queue(function() {
                $("#swiftContent").toggleClass("retract");
                 $(this).dequeue();
            });
        }
